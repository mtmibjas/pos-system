...
abstract final class AuthService {
  ...
  static const name = 'pos.v1.AuthService';
  ...
  static const registerDevice = connect.Spec(
    ...
    posv1auth_service.RegisterDeviceRequest.new,
    posv1auth_service.RegisterDeviceResponse.new,
  );
  ...
  static const login = connect.Spec(
    '/$name/Login',
    connect.StreamType.unary,
    posv1auth_service.LoginRequest.new,
    posv1auth_service.LoginResponse.new,
  );
}
