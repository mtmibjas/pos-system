...
import 'inventory_service.pbjson.dart';

export 'inventory_service.pb.dart';

abstract class InventoryServiceBase extends $pb.GeneratedService {
  $async.Future<$1.ListOnHandResponse> listOnHand(
      $pb.ServerContext ctx, $1.ListOnHandRequest request);

  $pb.GeneratedMessage createRequest($core.String methodName) {
    switch (methodName) {
      case 'ListOnHand':
        return $1.ListOnHandRequest();
      default:
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (methodName) {
      case 'ListOnHand':
        return listOnHand(ctx, request as $1.ListOnHandRequest);
      default:
        throw $core.ArgumentError('Unknown method: $methodName');
    }
  }
