...
const (
	...
	ItemServiceName = "pos.v1.ItemService"
)
...
const (
	...
	ItemServiceUpsertItemProcedure = "/pos.v1.ItemService/UpsertItem"
	// ItemServiceGetItemProcedure is the fully-qualified name of the ItemService's GetItem RPC.
	ItemServiceGetItemProcedure = "/pos.v1.ItemService/GetItem"
	// ItemServiceListItemsProcedure is the fully-qualified name of the ItemService's ListItems RPC.
	ItemServiceListItemsProcedure = "/pos.v1.ItemService/ListItems"
)

// ItemServiceClient is a client for the pos.v1.ItemService service.
type ItemServiceClient interface {
	UpsertItem(context.Context, *connect.Request[v1.UpsertItemRequest]) (*connect.Response[v1.UpsertItemResponse], error)
...
// NewItemServiceClient constructs a client for the pos.v1.ItemService service. By default, it uses
...
func NewItemServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ItemServiceClient {
	...
	itemServiceMethods := v1.File_pos_v1_item_service_proto.Services().ByName("ItemService").Methods()
	return &itemServiceClient{
		upsertItem: connect.NewClient[v1.UpsertItemRequest, v1.UpsertItemResponse](
			httpClient,
...
type itemServiceClient struct {
	upsertItem *connect.Client[v1.UpsertItemRequest, v1.UpsertItemResponse]
...
// UpsertItem calls pos.v1.ItemService.UpsertItem.
func (c *itemServiceClient) UpsertItem(ctx context.Context, req *connect.Request[v1.UpsertItemRequest]) (*connect.Response[v1.UpsertItemResponse], error) {
	return c.upsertItem.CallUnary(ctx, req)
}

// GetItem calls pos.v1.ItemService.GetItem.
...
// ListItems calls pos.v1.ItemService.ListItems.
...
// ItemServiceHandler is an implementation of the pos.v1.ItemService service.
...
func NewItemServiceHandler(svc ItemServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/pos.v1.ItemService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedItemServiceHandler) UpsertItem(context.Context, *connect.Request[v1.UpsertItemRequest]) (*connect.Response[v1.UpsertItemResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("pos.v1.ItemService.UpsertItem is not implemented"))
}
...
func (UnimplementedItemServiceHandler) GetItem(context.Context, *connect.Request[v1.GetItemRequest]) (*connect.Response[v1.GetItemResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("pos.v1.ItemService.GetItem is not implemented"))
}
...
func (UnimplementedItemServiceHandler) ListItems(context.Context, *connect.Request[v1.ListItemsRequest]) (*connect.Response[v1.ListItemsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("pos.v1.ItemService.ListItems is not implemented"))
}
